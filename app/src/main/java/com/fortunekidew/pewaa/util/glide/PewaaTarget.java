...
package com.fortunekidew.pewaa.util.glide;
 ...
 */
public class PewaaTarget extends GlideDrawableImageViewTarget implements
        Palette.PaletteAsyncListener {

    private final boolean autoplayGifs;

    public PewaaTarget(BadgedFourThreeImageView view, boolean autoplayGifs) {
        super(view);
    ...
    public void onResourceReady(GlideDrawable resource, GlideAnimation<? super GlideDrawable>
        ...
        if (resource instanceof GlideBitmapDrawable) {
            ...
            corner.recycle();
            badgedImageView.setBadgeColor(android.support.v4.content.ContextCompat.getColor(getView().getContext(),
    ...
    public void onGenerated(Palette palette) {
        ((BadgedFourThreeImageView) getView()).setForeground(
                ViewUtils.createRipple(palette, 0.25f, 0.5f,
                        android.support.v4.content.ContextCompat.getColor(getView().getContext(), R.color.colorGray), true));
    }
