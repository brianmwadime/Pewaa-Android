            ...
            case "NewUserNotification":
                ...
                if (newUserNotification.getRecipientId() == recipientId) {
                    ...
                    if (newUserNotification.getFile() != null) {
                        NotificationsManager.showUserNotification(WhatsCloneApplication.getAppContext(), messagingIntent, newUserNotification.getPhone(), newUserNotification.getFile(), recipientId, newUserNotification.getImage());
                    } else {
                        NotificationsManager.showUserNotification(WhatsCloneApplication.getAppContext(), messagingIntent, newUserNotification.getPhone(), newUserNotification.getMessage(), recipientId, newUserNotification.getImage());
                    }
                }
            ...
            case "NewGroupNotification":
                ...
                if (newGroupNotification.getGroupID() == groupID) {
                    ...
                    if (newGroupNotification.getFile() != null) {
                        NotificationsManager.showGroupNotification(WhatsCloneApplication.getAppContext(), messagingIntent, newGroupNotification.getGroupName(), newGroupNotification.getMemberName() + " : " + newGroupNotification.getFile(), newGroupNotification.getGroupID(), newGroupNotification.getImage());
                    } else {
                        NotificationsManager.showGroupNotification(WhatsCloneApplication.getAppContext(), messagingIntent, newGroupNotification.getGroupName(), newGroupNotification.getMemberName() + " : " + newGroupNotification.getMessage(), newGroupNotification.getGroupID(), newGroupNotification.getImage());
                    }
                }
