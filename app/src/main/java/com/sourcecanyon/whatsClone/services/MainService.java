...
//            AppHelper.LogCat("You are connected to chat server with id " + PreferenceManager.getSocketID(WhatsCloneApplication.getAppContext()));
//        });
//
...
//                        if (AppHelper.isActivityRunning(WhatsCloneApplication.getAppContext(), "activities.messages.MessagesActivity")) {
        ...
        mSocket.on(AppConstants.SOCKET_CONNECTED, args -> {
            ...
            try {
                ...
                if (connectedId != PreferenceManager.getID(WhatsCloneApplication.getAppContext())) {
                    ...
                    PreferenceManager.setSocketID(socketId, WhatsCloneApplication.getAppContext());
                    AppHelper.LogCat("You  are connected with socket id --> " + PreferenceManager.getSocketID(WhatsCloneApplication.getAppContext()) + " <---");
                }
    ...
    private void onReceivedNewMessageGroup() {
        ...
        mSocket.on(AppConstants.SOCKET_NEW_MESSAGE_GROUP_SERVER, args -> {
            ...
            try {
                ...
                data.put("socketId", PreferenceManager.getSocketID(WhatsCloneApplication.getAppContext()));
