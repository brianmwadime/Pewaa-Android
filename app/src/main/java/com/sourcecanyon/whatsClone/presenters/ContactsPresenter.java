...
public class ContactsPresenter implements Presenter {
    ...
    public void onCreate() {
        ...
        handler.postDelayed(() -> {
            try {
                mContactsService.getContactInfo(PreferenceManager.getID(WhatsCloneApplication.getAppContext())).subscribe(contactsModel -> AppHelper.LogCat("info user log contacts"), throwable -> AppHelper.LogCat("On error "));
