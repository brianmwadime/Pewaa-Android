...
import com.fortunekidew.pewaa.ui.widget.BaselineGridTextView;
import com.fortunekidew.pewaa.ui.widget.ElasticDragDismissFrameLayout;
import com.fortunekidew.pewaa.ui.widget.ParallaxScrimageView;
import com.fortunekidew.pewaa.util.ColorUtils;
import com.fortunekidew.pewaa.util.TransitionUtils;
...
//            holder.likesCount.setVisibility(isExpanded ? View.VISIBLE : View.GONE);
    ...
    /* package */ static class ContributorViewHolder extends RecyclerView.ViewHolder {
        ...
        @Bind(R.id.contributor_avatar) ImageView avatar;
        @Bind(R.id.contributor_name) AuthorTextView author;
        @Bind(R.id.time_ago) TextView timeAgo;
        @Bind(R.id.player_bio) TextView contributorBody;
