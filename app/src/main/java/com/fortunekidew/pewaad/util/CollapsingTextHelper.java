...
package com.fortunekidew.pewaad.util;
...
public final class CollapsingTextHelper {
    ...
    public void setCollapsedTextAppearance(int resId) {
        TypedArray a = mView.getContext().obtainStyledAttributes(resId, android.support.design.R.styleable.TextAppearance);
        if (a.hasValue(android.support.design.R.styleable.TextAppearance_android_textColor)) {
            mCollapsedTextColor = a.getColor(
                    android.support.design.R.styleable.TextAppearance_android_textColor, mCollapsedTextColor);
        }
        if (a.hasValue(android.support.design.R.styleable.TextAppearance_android_textSize)) {
            mCollapsedTextSize = a.getDimensionPixelSize(
                    android.support.design.R.styleable.TextAppearance_android_textSize, (int) mCollapsedTextSize);
        }
        a.recycle();
        recalculate();
    }
    ...
    public void setExpandedTextAppearance(int resId) {
        ...
        if (a.hasValue(android.support.design.R.styleable.TextAppearance_android_textColor)) {
            mExpandedTextColor = a.getColor(
                    android.support.design.R.styleable.TextAppearance_android_textColor, mExpandedTextColor);
        }
        if (a.hasValue(android.support.design.R.styleable.TextAppearance_android_textSize)) {
            mExpandedTextSize = a.getDimensionPixelSize(
                    android.support.design.R.styleable.TextAppearance_android_textSize, (int) mExpandedTextSize);
        }
        a.recycle();
        recalculate();
    }
